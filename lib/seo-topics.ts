...
export const seoTopics: SeoTopic[] = [
  {
    ...
    intro: "今日与近期重点足球赛程按比赛时间和对阵呈现；重点场次提供完整分析和参考方向。",
  ...
  },
  {
    ...
    intro: "世界杯2026赛程按比赛阶段呈现，小组赛、淘汰赛和重点比赛时间分开看；重点场次提供赛前分析。",
    primaryLink: { label: "世界杯赛程", href: "/world-cup-2026/schedule" },
    faq: [
      {
        question: "世界杯2026赛程主要看什么？",
        answer: "重点看世界杯比赛时间、赛事阶段、对阵信息和赛前分析。"
      },
      {
  ...
  },
  {
    ...
    intro: "按球队查找比赛时间、对阵和赛前分析。热门球队包含赛程、阵容名单和重点球员。",
    primaryLink: { label: "世界杯球队赛程", href: "/world-cup-2026/teams" },
    faq: [
      {
        question: "世界杯球队赛程主要看什么？",
        answer: "按球队看比赛时间、对阵信息、赛程阶段和赛前分析。"
      },
      {
        question: "哪些球队关注度更高？",
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "先确认世界杯赛程、举办城市、单场比赛和官方门票链接。"
      }
    ]
  },
  {
