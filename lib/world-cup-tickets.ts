...
export const ticketTopics: TicketTopic[] = [
  {
    ...
    description: "整理2026世界杯官方门票链接、购票提醒、赛程确认和观赛前需要核对的信息。",
    heading: "2026世界杯官方购票链接",
    intro: "世界杯门票信息以 FIFA 官方发布为准。购票前建议先确认比赛时间、举办城市、球场和入场规则，再通过官方票务链接查看最新安排。",
    points: [
    ...
    faq: [
      ...
      { question: "购票前应该确认什么？", answer: "建议确认比赛时间、举办城市、球场、参赛球队和官方入场要求。" }
    ]
  },
  {
    slug: "resale",
    title: "2026世界杯门票转让与二级市场提醒",
    description: "整理2026世界杯门票转让、二级市场和购票风险提醒，帮助中文球迷赛前核对官方信息。",
    ...
    faq: [
      ...
      { question: "绿茵智报提供门票转让吗？", answer: "不提供。本站只整理公开信息、赛程和观赛提醒。" }
    ]
  },
  {
    slug: "opening-match",
    ...
    intro: "揭幕战将在墨西哥城举行，是本届世界杯关注度最高的比赛之一。购票前建议同时核对揭幕战时间、城市、球场和官方票务链接。",
    points: [
    ...
    faq: [
      ...
      { question: "揭幕战门票什么时候买？", answer: "门票销售阶段和购票安排以 FIFA 官方发布为准，建议持续关注官方票务链接。" },
      { question: "揭幕战可以看什么？", answer: "可以查看比赛时间、举办城市、球场信息和赛前分析。" }
    ]
  },
  {
    slug: "final",
    ...
    intro: "决赛将在纽约/新泽西赛区举行，球场为 MetLife Stadium。决赛门票关注度高，购票前需要核对官方票务链接、比赛日期和入场要求。",
    points: [
    ...
    faq: [
      ...
      { question: "世界杯决赛门票信息在哪里确认？", answer: "建议以 FIFA 官方票务信息和赛事公告为准。" },
      { question: "决赛可以看什么？", answer: "可以查看决赛时间、举办城市、球场信息和淘汰赛安排。" }
    ]
  },
  ...hostCountries.map((country) => ({
    ...
    intro: `${country.name}是2026世界杯举办国家之一。计划前往${country.name}观赛时，建议先确认城市、球场、比赛时间和官方门票链接。`,
    points: [
    ...
    faq: [
      ...
      { question: `${country.name}世界杯门票信息在哪里看？`, answer: "建议以 FIFA 官方门票信息和赛事公告为准。" },
