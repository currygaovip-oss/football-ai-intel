...
export const aiModels: AiModel[] = [
  {
    ...
    risk_style: "均衡",
    recent_record: "样本30场 18中 / 6偏差 / 6未中",
    hit_rate: 60,
    average_score: 7.4,
  ...
  },
  {
    ...
    name: "盘口解码器",
    role: "指数结构理解模型",
    description: "读取赛前指数变化、市场温度和概率偏差，用于辅助识别方向是否过热或被低估。",
    specialties: ["指数变化", "市场温度", "概率偏差"],
    risk_style: "均衡",
    recent_record: "样本30场 17中 / 5偏差 / 8未中",
    hit_rate: 57,
    average_score: 7.1,
  ...
  },
  {
    ...
    risk_style: "均衡",
    recent_record: "样本30场 19中 / 4偏差 / 7未中",
    hit_rate: 63,
    average_score: 7.6,
  ...
  },
  {
    ...
    risk_style: "稳健",
    recent_record: "样本30场 16中 / 8偏差 / 6未中",
    hit_rate: 53,
    average_score: 7.2,
  ...
  },
  {
    ...
    risk_style: "进取",
    recent_record: "样本30场 13中 / 9偏差 / 8未中",
    hit_rate: 43,
    average_score: 6.8,
  ...
  },
  {
    ...
    risk_style: "均衡",
    recent_record: "样本30场 16中 / 6偏差 / 8未中",
    hit_rate: 53,
    average_score: 7.0,
  ...
  },
  {
    ...
    name: "热度守卫",
    role: "热度降噪模型",
    description: "过滤媒体叙事、社群热度和热门球队光环，提醒用户哪些判断可能被情绪放大。",
    specialties: ["舆论热度", "热门降噪", "风险提示"],
    risk_style: "稳健",
    recent_record: "样本30场 18中 / 5偏差 / 7未中",
    hit_rate: 60,
    average_score: 7.3,
  ...
  },
  {
    ...
    risk_style: "稳健",
    recent_record: "样本30场 17中 / 7偏差 / 6未中",
    hit_rate: 57,
    average_score: 7.5,
  ...
  },
  {
    ...
    risk_style: "复盘",
    recent_record: "样本30场 20中 / 4偏差 / 6未中",
    hit_rate: 67,
    average_score: 7.8,
  ...
  },
  {
    ...
    risk_style: "进取",
    recent_record: "样本30场 14中 / 8偏差 / 8未中",
    hit_rate: 47,
    average_score: 6.9,
...
export const predictions: Prediction[] = [
  {
    ...
    body: [
      ...
      "综合近期射门质量、定位球产出和替补席变化，本场更适合关注阿根廷方向，但需要接受前段时间僵持的风险。"
    ]
  },
  {
    id: "p2",
    ...
    body: [
      ...
      "本场并不适合过度放大主队热度，参考方向以主队不败为主，同时保留低比分路径。"
    ]
  },
  {
    id: "p3",
...
export const hotEvents: HotEvent[] = [
  ...
  },
  {
    ...
    matchup: "巴西 vs 美国",
    body: "重点观察巴西边锋与中锋的站位轮换，这类比赛更适合做阵容观察，不适合给出强倾向。",
