  ...
  return (
    <div className="space-y-5">
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLd(
            faqJsonLd([
              ...
              {
                question: "今日情报覆盖哪些赛事？",
                answer: "今日情报覆盖世界杯、五大联赛、中超、杯赛和当天焦点足球赛事。"
              }
            ])
          )
        }}
      ...
      <div className="flex flex-col gap-3 border-b border-white/10 pb-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <SectionHeading title="最新赛前观点" eyebrow="赛前分析" level={1} />
          <p className="mt-2 max-w-2xl text-sm leading-6 text-white/58">
            每场重点呈现参考方向，并展开球队状态、赛程强度、阵容消息和数据变化。
          </p>
        </div>
      ...
      <section className="rounded-lg border border-white/10 bg-white/[0.04] p-4">
          ...
          <p className="mt-2 text-sm leading-6 text-white/58">
            不同席位观察不同比赛变量：指数结构、球队状态、进球趋势、阵容变化和赛程压力。
          </p>
    ...
    >
      <div className="grid gap-3 lg:grid-cols-[1.05fr_1.1fr_auto] lg:items-center">
        <div>
          ...
          <span>更新：{prediction.published_at}</span>
          </div>
        </div>
