...
const description = "查看足球赛前分析、今日比赛观点、参考方向和完整分析入口，覆盖世界杯、五大联赛、杯赛和焦点赛事。";
    ...
    <div className="space-y-6">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLd(faqJsonLd([
            { question: "足球赛前分析页面看什么？", answer: "先看比赛对阵、时间和参考方向，再进入详情页阅读完整分析。" },
            { question: "赛前分析和赛后复盘有什么关系？", answer: "赛前分析记录比赛前的观点，赛后复盘用于回看原参考方向与实际走势的差异。" }
          ]))
        }}
      />
      ...
      <section className="rounded-lg border border-turf/20 bg-turf/[0.055] p-5 sm:p-7">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-7 text-white/62">
          今日已发布的比赛观点集中展示，先看参考方向，再进入详情页阅读完整分析。
        </p>
      </section>
