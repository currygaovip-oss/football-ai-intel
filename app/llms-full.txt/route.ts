...
export function GET() {
  ...
  const body = [
    ...
    line("2026世界杯北京时间", `${worldCupBasePath}/china-time`, "揭幕战、决赛、小组赛和淘汰赛的北京时间开球安排。"),
    line("2026世界杯抽签分组", "/topics/world-cup-2026-draw", "A组到L组球队、同组对手、小组赛顺序和淘汰赛路径。"),
    line("2026世界杯赛制规则", "/topics/world-cup-2026-format", "48队、12个小组、104场比赛和32强淘汰赛。"),
    line("2026世界杯举办球场", "/topics/world-cup-2026-stadiums", "美加墨举办城市、球场信息、比赛分布和观赛核对。"),
    line("2026世界杯在哪里举办", "/topics/world-cup-2026-where", "美国、加拿大、墨西哥联合举办，覆盖16座举办城市。"),
    line("2026世界杯什么时候开始", "/topics/world-cup-2026-start-date", "揭幕战为北京时间6月12日03:00，墨西哥对阵南非。"),
    line("2026世界杯时差与北京时间", "/topics/world-cup-2026-time-difference", "按北京时间、举办城市和比赛日交叉确认开球安排。"),
    line("2026世界杯亚洲球队赛程", "/topics/world-cup-2026-asian-teams", "日本、韩国等亚洲球队赛程、分组和赛前观察。"),
    line("赛程中心", "/schedule", "今日、明日、小组赛、淘汰赛和全部比赛时间。"),
    line("赛后复盘", "/reviews", "原参考方向、赛果、命中分类和偏差记录。"),
