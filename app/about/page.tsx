...
const aboutDescription = "绿茵智报提供足球赛程、赛前分析、参考方向和赛后复盘，面向中文球迷提供赛前阅读参考。";
    ...
    <article className="mx-auto max-w-4xl">
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLd(
            faqJsonLd([
              {
                question: "绿茵智报是什么？",
                answer: "绿茵智报是面向中文球迷的赛前情报网站，提供足球赛程、赛前分析、参考方向和赛后复盘。"
              },
              {
                question: "绿茵智报覆盖哪些比赛？",
              ...
              },
              {
                ...
                answer: "不代表。本站内容仅作足球交流、数据研究和赛前阅读参考，不构成任何结果承诺。"
              }
            ])
          )
        }}
      ...
      <div className="glass rounded-lg p-6 sm:p-8">
        ...
        <div className="mt-8 rounded-lg border border-gold/25 bg-gold/10 p-5 text-sm leading-7 text-white/70">
          明确声明：本站内容仅供足球交流、数据研究和赛前阅读参考，不构成任何结果承诺。请理性阅读，独立判断。
        </div>
      </div>
    </article>
  );
