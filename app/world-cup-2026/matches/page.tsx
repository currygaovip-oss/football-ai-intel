...
const description = "查看世界杯2026全部比赛列表，覆盖小组赛、淘汰赛、比赛时间、对阵信息和赛前分析入口。";
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="border-b border-white/10 pb-5">
        ...
        <p className="mt-3 max-w-3xl text-sm leading-7 text-white/62">按赛程顺序查看全部比赛。已发布赛前观点的比赛会显示参考方向和完整分析入口。</p>
      </section>
